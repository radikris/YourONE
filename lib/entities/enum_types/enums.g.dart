...
_$_Enums _$$_EnumsFromJson(Map<String, dynamic> json) => _$_Enums(
      ...
      musicTaste:
          $enumDecodeNullable(_$MusicTasteEnumMap, json['musicalTaste']),
      movieGenre: $enumDecodeNullable(_$MovieGenreEnumMap, json['filmTaste']),
      ...
      hobbies: $enumDecodeNullable(_$HobbiesEnumMap, json['interests']),
...
Map<String, dynamic> _$$_EnumsToJson(_$_Enums instance) => <String, dynamic>{
      ...
      'musicalTaste': _$MusicTasteEnumMap[instance.musicTaste],
      'filmTaste': _$MovieGenreEnumMap[instance.movieGenre],
      ...
      'interests': _$HobbiesEnumMap[instance.hobbies],
