...
mixin _$Enums {
  ...
  MusicTaste? get musicTaste => throw _privateConstructorUsedError;
  @JsonKey(name: 'filmTaste')
  MovieGenre? get movieGenre => throw _privateConstructorUsedError;
  ...
  Hobbies? get hobbies => throw _privateConstructorUsedError;
  @JsonKey(name: 'tattoo')
...
/// @nodoc
class _$EnumsCopyWithImpl<$Res> implements $EnumsCopyWith<$Res> {
  _$EnumsCopyWithImpl(this._value, this._then);

  final Enums _value;
  // ignore: unused_field
  final $Res Function(Enums) _then;
    ...
    return _then(_value.copyWith(
      ...
      children: children == freezed
          ...
          : children // ignore: cast_nullable_to_non_nullable
              as Children?,
      marriage: marriage == freezed
          ? _value.marriage
          : marriage // ignore: cast_nullable_to_non_nullable
              as Marriage?,
      musicTaste: musicTaste == freezed
          ? _value.musicTaste
          : musicTaste // ignore: cast_nullable_to_non_nullable
              as MusicTaste?,
      movieGenre: movieGenre == freezed
          ? _value.movieGenre
          : movieGenre // ignore: cast_nullable_to_non_nullable
              as MovieGenre?,
      religion: religion == freezed
          ? _value.religion
          : religion // ignore: cast_nullable_to_non_nullable
              as Religion?,
      horoscope: horoscope == freezed
          ? _value.horoscope
      ...
      hobbies: hobbies == freezed
          ...
          : hobbies // ignore: cast_nullable_to_non_nullable
              as Hobbies?,
      tattoo: tattoo == freezed
          ? _value.tattoo
          : tattoo // ignore: cast_nullable_to_non_nullable
              as Tattoo?,
      piercing: piercing == freezed
          ? _value.piercing
          : piercing // ignore: cast_nullable_to_non_nullable
              as Piercing?,
      ...
      eyeColor: eyeColor == freezed
          ...
          : eyeColor // ignore: cast_nullable_to_non_nullable
              as EyeColor?,
      glasses: glasses == freezed
          ? _value.glasses
          : glasses // ignore: cast_nullable_to_non_nullable
              as Glasses?,
      sportiness: sportiness == freezed
          ? _value.sportiness
          : sportiness // ignore: cast_nullable_to_non_nullable
              as Sportiness?,
      shape: shape == freezed
          ? _value.shape
...
/// @nodoc
class __$$_EnumsCopyWithImpl<$Res> extends _$EnumsCopyWithImpl<$Res>
    implements _$$_EnumsCopyWith<$Res> {
  __$$_EnumsCopyWithImpl(_$_Enums _value, $Res Function(_$_Enums) _then)
      : super(_value, (v) => _then(v as _$_Enums));

  @override
  _$_Enums get _value => super._value as _$_Enums;
...
class _$_Enums extends _Enums {
  const _$_Enums(
      ...
      @JsonKey(name: 'musicalTaste') this.musicTaste,
      @JsonKey(name: 'filmTaste') this.movieGenre,
      @JsonKey(name: 'religion') this.religion,
      @JsonKey(name: 'horoscope') this.horoscope,
      @JsonKey(name: 'languages') this.languages,
      @JsonKey(name: 'interests') this.hobbies,
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.educationLevel, educationLevel) &&
            const DeepCollectionEquality()
                .equals(other.cigarettes, cigarettes) &&
            const DeepCollectionEquality().equals(other.alcohol, alcohol) &&
            const DeepCollectionEquality().equals(other.children, children) &&
            const DeepCollectionEquality().equals(other.marriage, marriage) &&
            const DeepCollectionEquality()
                .equals(other.musicTaste, musicTaste) &&
            const DeepCollectionEquality()
                .equals(other.movieGenre, movieGenre) &&
            ...
            const DeepCollectionEquality().equals(other.glasses, glasses) &&
            const DeepCollectionEquality()
  ...
  int get hashCode => Object.hashAll([
        ...
        const DeepCollectionEquality().hash(educationLevel),
        const DeepCollectionEquality().hash(cigarettes),
        const DeepCollectionEquality().hash(alcohol),
        const DeepCollectionEquality().hash(children),
        const DeepCollectionEquality().hash(marriage),
        const DeepCollectionEquality().hash(musicTaste),
        const DeepCollectionEquality().hash(movieGenre),
...
abstract class _Enums extends Enums {
  const factory _Enums(
      ...
      @JsonKey(name: 'musicalTaste') final MusicTaste? musicTaste,
      @JsonKey(name: 'filmTaste') final MovieGenre? movieGenre,
      @JsonKey(name: 'religion') final Religion? religion,
      @JsonKey(name: 'horoscope') final Horoscope? horoscope,
      @JsonKey(name: 'languages') final Languages? languages,
      @JsonKey(name: 'interests') final Hobbies? hobbies,
